...
\markboth{Math Models of OR, Exam 1B, Fall 2003}
   {Math Models of OR, Exam 1B, Fall 2003}
...
\multicolumn{2}{r}{$x_1$ }&$x_2$ &$x_3$ &$x_4$ &
\multicolumn{1}{r}{$x_5$ } \\\hline
0&2&0&7&-2&0\\\hline
20&-4&0&3&2&1\\
80&1&1&4&4&0\\\hline
       \end{tabular}
...
\min &&& 3x_2 & - & 2x_3 \\
\mbox{subject to} & && 2x_2 & - & 3x_3 & + & x_4 & = & 6 \\
& x_1 & - & x_2 & - & 2x_3 &&& = & 5  \\
\multicolumn{8}{r}{x_i} & \geq & 0, \quad i=1,\ldots,4
\end{array}
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\min &&& x_2 \\
\mbox{subject to} && - & 6x_2 &&& + & x_4 & - & 2x_5 &&& = & 6 \\
& x_1 & + & x_2 &&&&& - & x_5 &&& = & 5 \\
&&& 2x_2 & + & x_3 &&& + & 2x_5 &&& = & 6 \\
&& - & 4x_2 &&&&& + & 4x_5 & + & x_6 & = & 16 \\
\multicolumn{12}{r}{x_i} & \geq & 0, \quad i=1,\ldots,6
\end{array}
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
